...
//    8.2对评论文章json进行下载 保存
    ...
    public  void Method_8_2_SaveComments(String path,String mainurl,String group_id,String _Singer,int begin ,int count){
        try {
...
//                对请求的参数处理一下
            ...
            Method_SaveFile(path,group_id+".txt", AllArry.toString());
            AllArry.clear();
        }catch (Exception e){
            e.printStackTrace();
        }
